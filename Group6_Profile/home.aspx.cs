...
public partial class home : System.Web.UI.Page
{
    ...
    void addShoppingCart(string comID, double price, string introduce, string imageUrl)
    {
        ...
        DataTable dataTable = new DataTable();
        data1.Fill(dataTable);
        if (dataTable.Rows.Count <= 0)  //no item
        {
            ...
            if (n > 0)
            {
                ...
                Response.Write("<script>alert('success！');location.href='home.aspx'</script>");
            }
            else
            {
                Response.Write("<script>alert('failed！');location.href='home.aspx'</script>");
            }
        }
    ...
    void addFavour(string comID, double price, string introduce, string imageUrl)
    {
        ...
        else if (dataTable.Rows.Count > 0)  
        {
            ...
            Response.Write("<script>alert('Product already in the wishlist！');location.href='home.aspx'</script>");
        }
        conn.Close();
    }
    //Cart
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string temp = (this.Label1.Text.ToString()).Replace("$", "");
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        string tep = this.Image1.ImageUrl.ToString();
        string tempID = (tep.Substring(tep.Length - 7)).Substring(0, 3);
        string temp = (this.Label3.Text.ToString()).Replace("$", ""); 
        double cprice = Convert.ToDouble(temp);
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        ...
        string tempID = (tep.Substring(tep.Length - 7)).Substring(0, 3);
        string temp = (this.Label5.Text.ToString()).Replace("$", ""); 
        double cprice = Convert.ToDouble(temp);
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        ...
        string tempID = (tep.Substring(tep.Length - 7)).Substring(0, 3);
        string temp = (this.Label7.Text.ToString()).Replace("$", ""); 
        double cprice = Convert.ToDouble(temp);
    ...
    protected void Button9_Click(object sender, EventArgs e)
    {
        ...
        string tempID = (tep.Substring(tep.Length - 7)).Substring(0, 3);
        string temp = (this.Label9.Text.ToString()).Replace("$", ""); 
        double cprice = Convert.ToDouble(temp);
    ...
    protected void Button11_Click(object sender, EventArgs e)
    {
        ...
        string tempID = (tep.Substring(tep.Length - 7)).Substring(0, 3);
        string temp = (this.Label11.Text.ToString()).Replace("$", ""); 
        double cprice = Convert.ToDouble(temp);
    ...
    protected void Button13_Click(object sender, EventArgs e)
    {
        ...
        string tempID = (tep.Substring(tep.Length - 7)).Substring(0, 3);
        string temp = (this.Label13.Text.ToString()).Replace("$", ""); 
        double cprice = Convert.ToDouble(temp);
    ...
    protected void Button15_Click(object sender, EventArgs e)
    {
        ...
        string tempID = (tep.Substring(tep.Length - 7)).Substring(0, 3);
        string temp = (this.Label15.Text.ToString()).Replace("$", ""); 
        double cprice = Convert.ToDouble(temp);
    ...
    protected void Button17_Click(object sender, EventArgs e)
    {
        ...
        string tempID = (tep.Substring(tep.Length - 7)).Substring(0, 3);
        string temp = (this.Label17.Text.ToString()).Replace("$", ""); 
        double cprice = Convert.ToDouble(temp);
