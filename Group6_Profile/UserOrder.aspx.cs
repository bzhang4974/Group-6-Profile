...
public partial class UserOrder : System.Web.UI.Page
{
    ...
    void loadData()
    {
        ...
        string SqlStr2 = $"select [orderID] ,[userID] ,[shopID] ,[orderTotalPrice] ,[shipAddress] ,[payMethod] , CONVERT(varchar(10), [payDate], 120 ) payDate,CONVERT(varchar(10), [signDate], 120 ) signDate,[tranStatus] from [new_order] where tranStatus='Pending payment' and [userID]='{Request.Cookies["UID"].Value.Trim()}'";
        ...
        string SqlStr3 = $"select [orderID] ,[userID] ,[shopID] ,[orderTotalPrice] ,[shipAddress] ,[payMethod] , CONVERT(varchar(10), [payDate], 120 ) payDate,CONVERT(varchar(10), [signDate], 120 ) signDate,[tranStatus] from [new_order] where tranStatus='Pending ' and [userID]='{Request.Cookies["UID"].Value.Trim()}'";
        ...
        string SqlStr4 = $"select [orderID] ,[userID] ,[shopID] ,[orderTotalPrice] ,[shipAddress] ,[payMethod] , CONVERT(varchar(10), [payDate], 120 ) payDate,CONVERT(varchar(10), [signDate], 120 ) signDate,[tranStatus] from [new_order] where tranStatus='Refund' and [userID]='{Request.Cookies["UID"].Value.Trim()}'";
        ...
        string SqlStr5 = $"select [orderID] ,[userID] ,[shopID] ,[orderTotalPrice] ,[shipAddress] ,[payMethod] , CONVERT(varchar(10), [payDate], 120 ) payDate,CONVERT(varchar(10), [signDate], 120 ) signDate,[tranStatus] from [new_order] where tranStatus='Completed' and [userID]='{Request.Cookies["UID"].Value.Trim()}'";
        ...
        string SqlStr6 = $"select [orderID] ,[userID] ,[shopID] ,[orderTotalPrice] ,[shipAddress] ,[payMethod] , CONVERT(varchar(10), [payDate], 120 ) payDate,CONVERT(varchar(10), [signDate], 120 ) signDate,[tranStatus] from [new_order] where tranStatus='Canceled' and [userID]='{Request.Cookies["UID"].Value.Trim()}'";
