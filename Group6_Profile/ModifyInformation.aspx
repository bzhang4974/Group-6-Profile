...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="width: 100%; height: 625px; background-color: white; position: relative; top: -10px" class="background">
        <h3 style="position: relative; left: 500px; top: 70px; font-family: 宋体; font-size: 35px; font-weight: 900;">Shop Info</h3>
        <table class="auto-style6">
            <tr>
                <td class="auto-style7">
                    <asp:Label ID="Label2" runat="server" Text="Shop ID:"></asp:Label>
            ...
            <tr>
                <td class="auto-style7">
                    <asp:Label ID="Label9" runat="server" Text="Register Date:"></asp:Label>
                </td>
                <td class="auto-style9">
        ...
        <asp:Button ID="Button1" runat="server" Height="40px" Text="change " Width="85px" BackColor="Lime" CssClass="button" OnClick="Button1_Click" />
        <asp:Button ID="Button2" runat="server" Height="40px" Text="Save" Width="85px" BackColor="Lime" CssClass="button" OnClick="Button2_Click" />
    </div>
</asp:Content>
