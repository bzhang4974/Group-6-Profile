...
public partial class Pinformation : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (n > 0)
        {
            Response.Write("<script>alert('change successfully！');location.href='Pinformation.aspx'</script>");
        }
        else
        {
            Response.Write("<script>alert('change failed！');location.href='Pinformation.aspx'</script>");
        }
        conn.Close();
    }
}