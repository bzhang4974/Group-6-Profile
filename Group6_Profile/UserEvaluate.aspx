    ...
    <div class="evalbody">
        <div class="menuDIV">
            <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" RenderingMode="Table" StaticEnableDefaultPopOutImage="False" CssClass="menuCSS" ForeColor="Black" OnMenuItemClick="Menu1_MenuItemClick">
                <Items>
                    <asp:MenuItem Text="Pending Rating Order " Value="Pending Rating Order " Selected="True"></asp:MenuItem>
                    <asp:MenuItem Text="Pending Rating Order " Value="Pending Rating Order "></asp:MenuItem>
                    <asp:MenuItem Text="Rated Order " Value="Rated Order "></asp:MenuItem>
                </Items>
