    ...
    <form id="form1" runat="server">
        ...
        <div>
            <table class="auto-style1">
                <tr>
                    <td class="auto-style6" colspan="3">Amzon</td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style8" colspan="3">
                        <table style="width: 100%;">
                            <tr>
                                <th></th>
                                <td>
                                    <asp:Button ID="Button1" runat="server" Text="Clear" Height="35px" Width="55px" BackColor="#00FF99" BorderColor="#99FFCC" OnClick="Button1_Click" />
                                </td>
                                <td>
                                    <asp:Button ID="Button2" runat="server" Text="Login" Height="35px" Width="55px" BackColor="#00FF99" BorderColor="#99FFCC" OnClick="Button2_Click" ValidationGroup="ValidataGroup1" />
                                </td>
                                <th>&nbsp;</th>
                            </tr>
                        </table>
            ...
            <div class="tipName">
                <p>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" Display="Dynamic" ErrorMessage="Account cannot be empty!!" ForeColor="Red" Font-Size="Medium" CssClass="" ValidationGroup="ValidataGroup1"></asp:RequiredFieldValidator>
                </p>
                
            </div>
            <div class="tipPWD">
                <p>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2" Display="Dynamic" ErrorMessage="Password cannot be empty!!" ForeColor="Red" Font-Size="Medium" CssClass="" ValidationGroup="ValidataGroup1"></asp:RequiredFieldValidator>
                </p>
            </div>
        </div>
    </form>
