    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div class="checkPWD" id="testD" runat="server">
                <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Inconsistent password!!!" Font-Size="Medium" ForeColor="#FF3300" ControlToCompare="TextBox3" ControlToValidate="TextBox4" ValidationGroup="ValidataGroup1" Display="Dynamic"></asp:CompareValidator>
            </div>
            <div class="checkTELL">
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Invalid phone format!!" ControlToValidate="TextBox5" Display="Dynamic" Font-Size="Medium" ForeColor="#FF3300" ValidationExpression="^5[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]{9}$" ValidationGroup="ValidataGroup1"></asp:RegularExpressionValidator>
            </div>
            <div style="height: 580px; width: 670px; margin: -75px auto; background-color: #FFFFFF; position: relative; border: 1px solid transparent">
                <div style="border: 3px solid #FF0000; height: 535px; width: 630px; margin: 20px auto; background-color: #FFFFFF; position: relative; padding-right: 40px; font-weight: 700">
                    <asp:Label CssClass="lab1" ID="Label1" runat="server" BackColor="White" Enabled="False" Height="28px" Text="Register" Width="100px" Font-Overline="False"></asp:Label>
                    <table class="auto-style1">
                        ...
                        <tr>
                            <td class="auto-style10">Nickname:</td>
                        </tr>
                        <tr>
                            <td class="auto-style10">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="DropDownList1" runat="server" Height="28px" Width="235px" Style="border-color: black; border-width: 2px;" CssClass="auto-style9" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="True">
                                                <asp:ListItem Selected="True">Profile 1</asp:ListItem>
                                                <asp:ListItem>Profile 2</asp:ListItem>
                                                <asp:ListItem>Profile 3</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            ...
                            <td class="auto-style12">Account type:</td>
                        </tr>
                        <tr>
                            <td class="auto-style10">
                    ...
                    <table class="auto-style7">
                        <tr>
                            <td class="auto-style6">
                                <asp:Button ID="Button1" runat="server" Font-Bold="True" Height="37px" Text="Login" Width="50px" OnClick="Button1_Click" />
                            </td>
                            <td class="auto-style6">
                                <asp:Button ID="Button2" runat="server" Font-Bold="True" Height="38px" Text="Clear" Width="50px" OnClick="Button2_Click" />
                            </td>
                            <td class="auto-style6">
                                <asp:Button ID="Button3" runat="server" Font-Bold="True" Height="38px" Text="Register" Width="50px" OnClick="Button3_Click" ValidationGroup="ValidataGroup1" />
                            </td>
                        </tr>
                    </table>
                </div>
