...
<div class="cartbody">
    <p>
        ...
        <asp:Label ID="Label1" runat="server" Text="123" CssClass="information" Height="70px" Width="295px"></asp:Label>
        ...
        <asp:Button ID="Button3" runat="server" Text="delete" CssClass="delete" OnClick="Button3_Click" />
    </p>
</div>
