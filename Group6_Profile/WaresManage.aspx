    ...
    <div style="width: 1406px; height: 600px; background-color: white; position: relative; left: 15px;">
        <div style="background-color: #CCCCCC; height: 31px; width: 100%">
            <asp:Menu ID="Menu1" runat="server" BackColor="#CCCCCC" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="0px" DisappearAfter="200" Orientation="Horizontal" RenderingMode="Table" Width="500px" CssClass="menuborder" ForeColor="#333333" OnMenuItemClick="Menu1_MenuItemClick">
                <Items>
                    <asp:MenuItem Text="All Product" Value="0" Selected="True"></asp:MenuItem>
                    <asp:MenuItem Text="To be listed" Value="1"></asp:MenuItem>
                    <asp:MenuItem Text="Sold" Value="2"></asp:MenuItem>
                    <asp:MenuItem Text="Out of stock" Value="3"></asp:MenuItem>
                    <asp:MenuItem Text="Removed" Value="4"></asp:MenuItem>
                </Items>
        ...
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
            <asp:View ID="View1" runat="server">
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" Font-Size="Large" CssClass="data" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="0" PageSize="15" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting" Width="100px">
                    <Columns>
                        ...
                        <asp:BoundField DataField="comName" HeaderText="Product Name"></asp:BoundField>
                        <asp:BoundField DataField="comType" HeaderText="Product Type" />
                        ...
                        <asp:BoundField DataField="comIntroduction" HeaderText="Product Detail"></asp:BoundField>
                        <asp:BoundField DataField="comAddress" HeaderText="Product Address"></asp:BoundField>
                        <asp:BoundField DataField="saleStatu" HeaderText="Sale Status">
            ...
            <asp:View ID="View3" runat="server">
                <div style="padding: 7px; text-align: center; vertical-align: middle; padding-right: 200px">
                    ...
                    <input id="Button3" type="button" value="search" style="width: 60px; height: 40px; vertical-align: bottom; margin: auto; background-color: #5da7fb; outline: none; border: none; font-family: 宋体; font-size: x-large; position: relative; right: 7px;" />
                </div>
            ...
            <asp:View ID="View5" runat="server">
                <div style="padding: 7px; text-align: center; vertical-align: middle; padding-right: 200px">
                    ...
                    <input id="Button9" type="button" value="search" style="width: 60px; height: 40px; vertical-align: bottom; margin: auto; background-color: #5da7fb; outline: none; border: none; font-family: 宋体; font-size: x-large; position: relative; right: 7px;" />
                </div>
