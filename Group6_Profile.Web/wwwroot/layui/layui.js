        ...
        var t,
          ...
          s = {
            ...
            next: r.next
              ...
              : "",
            count:
              '<span class="layui-laypage-count">total ' +
              r.count +
              " colnum</span>",
            limit:
            ...
            skip: [
              '<span class="layui-laypage-skip">to',
...
layui.define(["layer", "util"], function (e) {
  ...
  var C = layui.$,
    ...
    t = function () {
      this.config = {
        verify: {
          required: [/[\S]+/, "The required fields cannot be blank"],
          ...
          number: function (e) {
            if (!e || isNaN(e)) return "Fill in numbers only";
          },
          date: [
...
layui.define(["layer", "form"], function (t) {
  ...
  var u = layui.$,
    ...
    C = {
      ...
      image:
        '<i class="layui-icon layedit-tool-image" title="picture" layedit-event="image">&#xe64a;<input type="file" name="file"></i>',
      code: '<i class="layui-icon layedit-tool-code" title="Insert code" layedit-event="code">&#xe64e;</i>',
      help: '<i class="layui-icon layedit-tool-help" title="assist" layedit-event="help">&#xe607;</i>',
    },
    e = new e();
  t(i, e);
});
